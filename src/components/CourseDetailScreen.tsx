...
const participants = [
  ...
  { id: 4, name: 'Dr. Ra', avatar: '🎰' },
];

export function CourseDetailScreen({ course, onBack, onOpenChat }) {
  return (
    <div className="min-h-screen bg-white">
      <div className="w-full max-w-[393px] mx-auto">
        ...
        <div className="p-6 space-y-6">
          {/* Description */}
          <div>
            <h3 className="text-[#333333] mb-3">Kursbeschreibung</h3>
            <p className="text-[#666666] leading-relaxed">
              {courseDescriptions[course.id] || "Keine Beschreibung verfügbar."}
            </p>
          </div>
          ...
          {/* Participants */}
          <div>
            <h3 className="text-[#333333] mb-3">Teilnehmer ({participants.length})</h3>
          ...
          {/* Useful Links */}
          <div>
            <h3 className="text-[#333333] mb-3">Nützliche Links</h3>
            <div className="space-y-3">
              <a
                href="#"
              ...
              >
                <span className="text-[#333333]">ILIAS Kurs</span>
              ...
              <a
                ...
                className="flex items-center justify-between p-4 bg-white border border-[#E0E0E0] rounded-[12px] hover:bg-[#F5F5F5] transition-colors"
              >
                <span className="text-[#333333]">Discord verknüpfen</span>
                <ExternalLink className="w-5 h-5 text-[#666666]" />
              </a>
              <a
                href="#"
                className="flex items-center justify-between p-4 bg-white border border-[#E0E0E0] rounded-[12px] hover:bg-[#F5F5F5] transition-colors"
              >
                <span className="text-[#333333]">WhatsApp verknüpfen</span>
                <ExternalLink className="w-5 h-5 text-[#666666]" />
              </a>
            </div>
          </div>
