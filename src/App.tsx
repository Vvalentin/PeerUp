...
export default function App() {
  ...
  if (currentScreen === 'assessment') {
    return <SubjectAssessmentScreen course={selectedCourse} onComplete={handleAssessmentComplete} />;
  }

  if (currentScreen === 'matchSuccess') {
    return <MatchSuccessModal onClose={handleMatchSuccessClose} />;
  }

  if (currentScreen === 'courseDetail') {
    return <CourseDetailScreen course={detailCourse} onBack={handleBackFromDetail} onOpenChat={handleOpenChat} />;
  }

  if (currentScreen === 'groupChat') {
    return <GroupChatScreen course={detailCourse} onBack={handleBackFromChat} />;
  }
